...
class _DeliveryTabState extends State<DeliveryTab> {
  ...
  List<Map<String, dynamic>> allOrdersData = [
    ...
    },
    {
      'number': '01288663015',
      'name': 'Hanin Ahmed',
      'image': 'https://cdn.al-ain.com/images/2021/1/13/133-195934-hanin-hossam-cairo-university-spreading-immorality_700x400.jpg',
      'time': '5:25 PM',
      'distance': '3 KM',
      'address': '64 شارع نصر الدين امام سوبرماركت الهدايا الدور الاول علوي شقه 8',
      'location': '31.2062316,29.9111692',
      'itemsList': [
    ...
    return BlocConsumer<AdminCubit, AppStates>(
      ...
      builder: (BuildContext context, AppStates state) {
        ...
        return AnimatedSwitcher(
          ...
          child: allOrdersData.isEmpty? Column(
            key: const Key("column2"),
            mainAxisAlignment: MainAxisAlignment.center,
            children: const [
              Icon(Icons.done_outline_rounded,size: 60,),
